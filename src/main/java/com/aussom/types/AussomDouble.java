...
public class AussomDouble extends AussomObject implements AussomTypeInt, AussomTypeObjectInt {
	...
	public AussomDouble() {
		...
		astClass def = Universe.get().DOUBLE_CLASS_DEF;
		if (def != null) this.setClassDef(def);
	}

	@Override
	public AussomType clone() {
		AussomDouble n = new AussomDouble();
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AussomDouble)) return false;
		return Double.compare(this.value, ((AussomDouble)o).value) == 0;
	}
